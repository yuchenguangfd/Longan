...
public:
    ...
    const UserVector<UserVectorAlloc>& GetUserVector(int userId) const { return mUserVectors[userId]; }
    UserVector<UserVectorAlloc>& GetUserVector(int userId) { return mUserVectors[userId]; }
protected:
    int mNumRating;
    int mNumUser;
    int mNumItem;
